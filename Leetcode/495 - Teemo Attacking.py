...
# When Teemo attacks Ashe, Ashe gets poisoned for
# a exactly duration seconds.
...
timeSeries = [1,4]
duration = 2
print(obj.findPoisonedDuration(timeSeries, duration))   # Output: 4
...
timeSeries = [1,2]
duration = 2
print(obj.findPoisonedDuration(timeSeries, duration))   # Output: 3
# Explanation: Teemo's attacks on Ashe go as follows:
# - At second 1, Teemo attacks, and Ashe is poisoned for seconds 1 and 2.
