...
class Solution:
    def reverseBits(self, n: int) -> int:
        ...
        # Needed more study about bit things.
...
print(ob.reverseBits(n))    # Output: 964176192 (00111001011110000010100101000000)
...
n = '00000010100101000001111010011100'
print(ob.reverseBits(n))    # Output: 3221225471 (10111111111111111111111111111111)
