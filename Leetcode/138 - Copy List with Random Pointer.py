...
print(ob.copyRandomList(head))  # Output: [[7,null],[13,0],[11,4],[10,2],[1,0]]

head = [[1, 1], [2, 1]]
print(ob.copyRandomList(head))  # Output: [[1,1],[2,1]]

head = [[3, None], [3, 0], [3, None]]
print(ob.copyRandomList(head))  # Output: [[3,null],[3,0],[3,null]]